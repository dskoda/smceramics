'''linearregression_diagnostics_tetragonal
...
#features = [0,1,2,3,4,5,6,7]  # features (column index) to consider [all features]
features = [1,5,7]
...
msestat = mse*n/(n-k-1)
print('RMSE (ML, %g df) = %.6f' % (n,mse**0.5))   # ML community
print('RMSE (stats, %g df) = %.6f' % (n-k-1,msestat**0.5))   # stats community
